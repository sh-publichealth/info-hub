...
| [visit12_registry]{.highlight2} | ***(derived)*** Most recent visit in the past 12 months            | text (decimal) | –                                | Y        |
| [visit24_registry]{.highlight2} | ***(derived)*** Most recent visit 12-24 months ago            | text (decimal) | –                                | Y        |
| [visit36_registry]{.highlight2} | ***(derived)*** Most recent visit 24-36 months ago            | text (decimal) | –                                | Y        |
| [dohba1c_registry]{.highlight2}    | **(auto-populate)** Date of last HbA1C measurement                | YYYY-MM-DD     | –                                | Y        |
| [hba1c_treat_registry]{.highlight2} | HbA1C ≥ 43 mmol/mol & < 88 mmol/mol if on treatment with any hypoglycaemic agents             | text (decimal) | –                                | Y        |
| [hba1c_notreat_registry]{.highlight2} | HbA1C ≥ 48 mmol/mol & < 88 mmol/mol if **NOT** on treatment with any hypoglycaemic agents             | text (decimal) | –                                | Y        |
